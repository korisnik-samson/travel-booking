...
const Map = ({ setCoordinates, setBounds, coordinates, places, setChildClicked, weatherData }) => {
    ...
    return (
        <div className={classes.mapContainer}>
            <GoogleMapReact bootstrapURLKeys={{ key: process.env.REACT_APP_MAP_KEY1 }}
                            ...
                            <Paper elevation={3} className={classes.paper}>
                                ...
                                <img className={classes.pointer}
                                     src={place.photo ? place.photo.images.large.url :
                                         'https://www.foodserviceandhospitality.com/wp-content/uploads/2016/09/' +
                                         'Restaurant-Placeholder-001.jpg'}
                                     alt={place.name}
                                />
